...
public class RegistroDetalleCompraIngrediente {
	...
	public static DetalleCompraIngrediente ingresar(Scanner scanner) {
		 int codDetalle = 0;
	     int codCompraIng = InputTypes.readInt("Ingrese el codigo de Compra Ingrediente: ", scanner);
		 int codIngrediente = InputTypes.readInt("Ingrese el codigo de Ingrediente: ", scanner);
